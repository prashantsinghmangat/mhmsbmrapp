package com.example.mhmsbmrapp.DashboardBmr.Out_Patient_Dashboard.activity.OpTherapy.adapter;
...
public class RecyclerViewAdapterOpTherapy extends RecyclerView.Adapter<RecyclerViewAdapterOpTherapy.MyViewHolder> {

    private Context mContext ;
    private List<AnimeOpTherapy> mData ;
    RequestOptions option;


    public RecyclerViewAdapterOpTherapy(Context mContext, List<AnimeOpTherapy> mData) {
