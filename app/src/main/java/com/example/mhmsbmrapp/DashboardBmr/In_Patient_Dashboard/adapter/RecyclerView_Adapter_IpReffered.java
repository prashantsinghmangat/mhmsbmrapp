package com.example.mhmsbmrapp.DashboardBmr.In_Patient_Dashboard.adapter;
...
public class RecyclerView_Adapter_IpReffered extends RecyclerView.Adapter<RecyclerView_Adapter_IpReffered.MyViewHolder> {
    ...
    @NonNull
    @Override
    public RecyclerView_Adapter_IpReffered.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view ;
        LayoutInflater inflater = LayoutInflater.from(mContext);
        view = inflater.inflate(R.layout.op_patientbmr_list,parent,false) ;
        final RecyclerView_Adapter_IpReffered.MyViewHolder viewHolder = new RecyclerView_Adapter_IpReffered.MyViewHolder(view) ;
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerView_Adapter_IpReffered.MyViewHolder holder, int position) {
